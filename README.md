...
| Field | Value |
| --- | --- |
| **Name** | `hermes-gateway-restart-skill` |
...
cp -r hermes/hermes-gateway-restart ~/.hermes/skills/hermes/hermes-gateway-restart/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/hermes-gateway-restart-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/hermes-gateway-restart-skill.git ~/.hermes/skills/hermes/hermes-gateway-restart/
```
...
```text
skill_view(name="hermes/hermes-gateway-restart")
```
...
```text
Use the hermes gateway restart skill to <describe your specific task here>
```
...
```text
Gunakan skill hermes gateway restart untuk <deskripsikan tugas spesifik Anda di sini>
```
